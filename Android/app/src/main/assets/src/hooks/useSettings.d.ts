...
export declare const SettingsContext: React.Context<Settings.Context>;
export declare const useSettings: () => Settings.Context;
export declare const useTheme: () => {
    scheme: any;
    theme: import("@mui/material").Theme;
};
export declare const SettingsProvider: (props: React.PropsWithChildren) => import("react/jsx-runtime").JSX.Element;
